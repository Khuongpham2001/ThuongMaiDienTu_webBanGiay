    ...
    <div class="info-content-right">
        <div class="info-content-right-product_add">
                    ...
                    <?php
                        ...
                        {
                            ?>
                            <form action="./xuly/editinfor.php" method="POST" enctype="multipart/form-data">
                                <label for="">Email</label>
                                <p id="info-edit-email"><?php echo $kq['Email']; ?></p>
                                <input name="MaTK" type="text" style="display:none;" value="<?php echo $_SESSION['id']; ?>">

                                <label for="">Họ tên <span style="color:red;">*</span></label>
                                <input name="TenKhachHang" required type="text"  style="width:500px;" value="<?php echo $kq01['TenKhachHang']; ?>">
            
                                <label for="">Số điện thoại <span style="color:red;">*</span></label>
                                <input name="SDT" required type="text"  style="width:500px;" value="<?php echo $kq01['SDT']; ?>" >
            
                                <label for="">Địa chỉ <span style="color:red;">*</span></label>
                                <input name="DiaChi" required type="text"  style="width:500px;" value="<?php echo $kq01['DiaChi']; ?>">
                        ...
                        else
                        {
                            ...
                            <form action="./xuly/editinfor.php" method="POST" enctype="multipart/form-data">
                                ...
                                <label for="">Họ tên <span style="color:red;">*</span></label>
                                <input name="TenKhachHang" required type="text"  style="width:500px;" value="">
            
                                <label for="">Số điện thoại <span style="color:red;">*</span></label>
                                <input name="SDT" required type="text"  style="width:500px;" value="" >
            
                                <label for="">Địa chỉ <span style="color:red;">*</span></label>
                                <input name="DiaChi" required type="text"  style="width:500px;" value="">
